import logging
import asyncio
from services.PriceService import get_current_price, get_min_price, get_max_price, get_cheapest_period, get_today, calculate_average, calculate_day_rating
...
async def main():
    if curr_price.hour == cheapest_period[0].hour and rating != "Malo":
        await turn_on()
    else:
        logging.info(
